...
describe('Sudoku solver', function() {
  ...
  xit('solves a board wxith only 1 missing square', function() {
  ...
  xit('solves a board wxith only Naked Singles', function() {
  ...
  xit('solves a board wxith hidden singles', function() {
